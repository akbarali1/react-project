                  ...
                  <div className="row">
                    ...
                    <div className="col-md-6">
                      ...
                      <div className="more-info">
                        <p className="lead">
                          Men bilan to`g`ridan to`g`ri bog`lanmoqchi bo`lsangiz
                          telegram orqali bog`lanishingiz mumkin. Meni
                          telegramdan <a href="https:/t.me/kbarali">@kbarali</a>{" "}
                          deb qidiring
                        </p>
                        <ul className="list-ico">
                          <li>
                            <span className="ion-ios-location"></span> NAMANGAN
                            VILOYATI, UCHQO`RG`ON TUMANI
                          </li>
                          <li>
