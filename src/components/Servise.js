              ...
              <div className="service-box">
                ...
                <div className="service-content">
                  ...
                  <p className="s-description text-center">
                    Agarda sizda tayyor PSD bo`lsa HTML CSS JSda yasab berishim
                    mumkun. <br /> (Lekin o`zim 0 dan fantaziya qilib dizayn
                    qila olmayman).
                  </p>
                </div>
              </div>
            ...
            <div className="col-md-4">
              <div className="service-box">
                ...
                <div className="service-content">
                  ...
                  <p className="s-description text-center">
                    Sizda tayyor Frontend bo`lsa (HTML CSS JS) men YII2, Johncms
                    yoki sof phpda, kelajakda esa Laravelda Backend qismini
                    qilib berishim mumkun.
                  </p>
                </div>
              </div>
            </div>
